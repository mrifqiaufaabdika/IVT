        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="col-md-7">
              ...
              <?php
              $tampilTgl = date('d/m/Y',strtotime($data['tgl_bayar']));
              echo $tampilTgl?>
            </div>
          </div>
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-default icon-btn" href="#" data-dismiss="modal"><i class="fa fa-fw fa-lg fa-times-circle"></i>Tutup</a>&nbsp;&nbsp;&nbsp;
