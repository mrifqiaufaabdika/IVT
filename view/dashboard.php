          ...
          <div class="col-md-6">
                  ...
                  <!-- <div class="col-md-6">
                          <div class="card">
                                      ...
                                      <div class="card-footer"><?php echo date("d/m/Y"); ?></div>
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="col-md-9">
              ...
              <div class="radio-inline">
                <label>
                  <input type="radio" name="iuran" value="20000" required>Rp.20.000
                </label>
              </div>
              <div class="radio-inline">
                <label>
                  <input type="radio" name="iuran" value="30000"  required>Rp.30.000
                </label>
              </div>
              <div class="radio-inline">
                <label>
                  <input type="radio" name="iuran" value="40000" required>Rp.40.000
                </label>
              </div>
              <div class="radio-inline">
                <label>
                  <input type="radio" name="iuran" value="50000" required>Rp.50.000
                </label>
              </div>
            </div>
          </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="modal-footer">
            ...
            <button class="btn btn-default icon-btn" data-dismiss="modal" ><i class="fa fa-fw fa-lg fa-close"></i>Batal</button>&nbsp;&nbsp;&nbsp;
            <button class="btn btn-warning icon-btn" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Putuskan</button>
