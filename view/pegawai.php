...
if($_SESSION['tipe'] != 'admin'){
 ...
 <?php
   ...
   $sqlPel ="select max(NIP) as maxKode from pegawai";
   $hasilPel = mysql_query($sqlPel);
   $dataPel=mysql_fetch_array($hasilPel);
   $ID_Peg = $dataPel['maxKode'];
   $ID_Peg++;
 ?>
                ...
                <div class="modal-body">
                  <form class="form-horizontal" action="../control/prosesPegawai.php?action=tambah" method="post">
                    <div class="form-group">
                      ...
                      <div class="col-md-8">
                        <input class="form-control" name="NIP"type="text" value="<?echo $ID_Peg ?>" readonly>
                      </div>
                    </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <input class="form-control col-md-8" type="text"  name='noHP'placeholder="NO Handphone" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-md-3">Alamat</label>
                    <div class="col-md-8">
                      <textarea class="form-control" rows="4" name='alamat'placeholder="Alamat Pegawai" required></textarea>
                    </div>
                  </div>
                  <div class="form-group">
