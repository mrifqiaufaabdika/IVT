...
include "../../koneksi/koneksi.php";
 $sql ="select a.*,b.*,c.* from transaksi a,pelanggan b,pegawai c where a.jenis_pembayaran ='Iuran Bulanan' and a.id_pelanggan =b.id_pelanggan and a.NIP = c.NIP and MONTH(a.tgl_pembayaran)='$active' ";
...
<table width="100%" align="center"  >
 ...
 <tr>
   ...
   <td colspan="2" align="center"><h4>Laporan Pendapatan Bulanan PT.Indragiri Vision Terpadu  </h4></td>
 </tr>
 <br>
 <tr>
   <td>
