...
include "../../koneksi/koneksi.php";
 $sql ="select COUNT(a.no_faktur) as jml_pebayaran,SUM(a.total) as total, b.area from transaksi a,pelanggan b where a.jenis_pembayaran ='Iuran Bulanan' and a.id_pelanggan =b.id_pelanggan and YEAR(a.tgl_pembayaran)='2017' GROUP BY b.area";
