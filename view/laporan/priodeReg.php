...
<table width="100%" align="center"  >
 ...
 <tr>
   ...
   <td colspan="2" align="center"><h4>Laporan Pendapatan Regristrasi PT.Indragiri Vision Terpadu  </h4></td>
 </tr>
 <br>
 <tr>
   <td>
   ...
   <?php  $tampilTgl = date('d/m/Y',strtotime($dari));
   $tampilTgl1 = date('d/m/Y',strtotime($sampai));?>
   <td >: <?php echo $tampilTgl ; ?> S/d <?php echo $tampilTgl1 ; ?> </td>
 </tr>
