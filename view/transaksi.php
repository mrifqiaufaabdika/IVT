          ...
          <div class="well bs-component">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  ...
                  $hasil=mysql_query($sql);
                  $data=mysql_fetch_array($hasil);
                  $jumlahPelanggan = mysql_num_rows($hasil);
              ...
              <table>
                  ...
                  <form class="form-horizontal" action="../control/prosesTransaksi.php" method="post">
                    ...
                    //  }
                      //byr terakhir
                        ...
                        $dateTerakhir = date_parse ($tgl_byr);
                        $thnTerakhir = $dateTerakhir ['year'];
                        $blnTerakhir = $dateTerakhir ['month'];
                        $tglTerakhir = $dateTerakhir ['day'];
                      //sekarang
                      if($data['status']=="non-aktif"){
                        $tgl_byr_skg = $data['tgl_putus'];
                        // list($thnSkg,$blnSkg,$tglSkg)= split('[-]',$tgl_byr_skg);
                        $dateByrSkg = date_parse ($tgl_byr_skg);
                        $thnSkg = $dateByrSkg ['year'];
                        $blnSkg = $dateByrSkg ['month'];
                        $tglSkg = $dateByrSkg ['day'];
                      }else{
                      ...
                      //mulai bayar
                        ...
                        // $tgl_bayar =date_create($data['$tgl_bayar']);
                        // $dateBayar = date_parse ($tgl_bayar);
                        // $thnMulai = $dateBayar ['year'];
                        // $blnMulai = $dateBayar ['month'];
                        // $tglMulai = $dateBayar ['day'];


                          $interval=$blnSkg-$blnTerakhir;
                          if ($interval < 0 && $data['status']=="non-aktif"){
                            $interval = 0;
                          } else if($interval < 0 && $data['status'] =="aktif"){
                ...
                <?php } else if ($jumlahPelanggan == 0 &&  $id_pelanggan != null){
                  echo"<center><i class='fa fa-lg fa-frown-o'></i><h3 ><strong>Pelanggan Tidak Ditemukan !</strong> Cek Kembali Id Pelanggan</h3></center>";
                }?>
          </div>
