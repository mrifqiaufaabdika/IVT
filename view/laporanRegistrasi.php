...
$sampai=@$_GET['sampai'];
 ...
 <div class="page-title">
   <div>
     <h1><i class="fa fa-file-pdf-o"></i> Laporan Transaksi Registrasi</h1>
   ...
   <div>
     <ul class="breadcrumb">
       ...
       <li><a href="../view/index.php?page=laporan">Laporan</a></li>
        <li><a href="#" class="active">Laporan Reg-Priode</a></li>
     </ul>
   </div>
 </div>
<div class="row">
  <div class="col-md-12">
    <div class="card">
      ...
      <form class="form-horizontal" action="../control/tglPriode.php?id=registrasi" method="post" >
        <div class="row">
          <div class="col-md-3">
...
<?php if($dari != null && $sampai != null){ ?>
  <div class="col-md-12">
    <div class="panel panel-default">
      <div class="panel-heading"><a  class="btn btn-primary" href="laporan/priodeReg.php?dari=<?php echo $dari ?>&sampai=<?php echo $sampai ?>"  ><span class="fa fa-lg fa-print"></span> Print</a></div>
      <div class="panel-body">
        ...
        <table class="table table-hover table-bordered" id="sampleTable">
          ...
          <tbody>
            ...
            $sql ="select a.*,b.*,c.* from transaksi a,pelanggan b,pegawai c where a.jenis_pembayaran ='Registrasi' and a.tgl_pembayaran BETWEEN '$dari' and '$sampai' and a.id_pelanggan =b.id_pelanggan and a.NIP = c.NIP";
