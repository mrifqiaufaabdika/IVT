                        ...
                        <table class="table table-hover table-bordered" id="sampleTable">
                          ...
                          <tbody>
                            ...
                            echo"<tr>";
                              ...
                              echo "<td>"?>
                                  <a href="#" class='open_view' id='<?php echo $data['id_pelanggan']; ?>'><span class="fa fa-lg fa-eye"></span></a>&nbsp&nbsp<a   class="demoSwal" id='<?php echo $data['id_pelanggan']; ?>'><i class="fa fa-lg fa-user-times"></i></a>&nbsp&nbsp<a href="#" class='open_modal' id='<?php echo $data['id_pelanggan']; ?>'><span class="fa fa-lg fa-edit"></span></a>
                                <?php "</td>";
                            echo "</tr>";
                          }
                            ?>
