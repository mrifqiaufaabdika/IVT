              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <input class="form-control col-md-8" type="password" name="password"placeholder="Password">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <div class="radio-inline">
                        <label>
                          <input type="radio" name="tipeAkun" value="Administrator">Administrator
                        </label>
                      </div>
                      <div class="radio-inline">
                        <label>
                          <input type="radio" name="tipeAkun" value="Direktur">Direktur
                        </label>
                      </div>
                    </div>
                  </div>
