...
$dari = $_GET['dari'];
$sampai = $_GET['sampai'];
 $sql ="select a.*,b.*,c.* from transaksi a,pelanggan b,pegawai c where a.tgl_pembayaran BETWEEN '$dari' and '$sampai' and a.id_pelanggan =b.id_pelanggan and a.NIP = c.NIP";
...
<table width="100%" align="center"  >
 ...
 <tr>
   ...
   <td colspan="2" align="center"><h4>Laporan Pendapatan Priode PT.Indragiri Vision Terpadu  </h4></td>
 </tr>
 <br>
 <tr>
   <td>
   ...
   <td >: <?php echo $dari ; ?> S/d <?php echo $sampai ; ?> </td>
 </tr>
