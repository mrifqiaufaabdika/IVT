...
if (@$_GET['no_faktur'] != null) {
  ...
  $nip=$data['NIP'];
  $sqlPetugas = "select * from pegawai where NIP='$nip'";
  $dataPegawai=mysql_fetch_array(mysql_query($sqlPetugas));
  $id_pel=$data['id_pelanggan'];
  $sql2="select * from pelanggan where id_pelanggan='$id_pel'";
...
<fieldset>
    ...
    <tr>
       <td align="center"colspan="2"><h4 >Bukti Pembayaran</h4></td>
    </tr>
     </table>
...
<tbody>
  <tr>
    <td>ID Pelanggan </td><td>&nbsp:&nbsp </td><td><?php echo $data2['id_pelanggan'] ;?></td>
  </tr>
  <tr>
    <td>Nama</td><td> &nbsp:&nbsp </td><td><?php echo $data2['nama_pelanggan'] ;?></td>
  </tr>
  <tr>
    <td>Alamat</td><td> &nbsp:&nbsp </td><td><?php echo $data2['alamat'] ;?></td>
  </tr>
  <tr>
    <td>Jumlah TV</td><td> &nbsp:&nbsp</td><td><?php echo $data2['jumlah_tv'] ."   ( Rp ". format_rupiah($data2['iuran']).")";?></td>
  </tr>
...
<tbody>
<tr>
  <td>No Transaksi</td><td>&nbsp:&nbsp </td><td><?php echo $no_faktur; ?></td>
</tr>
<tr>
...
<div class="col-md-12">
  ...
  <div class="table-responsive">
    ...
    // }
    //query max tgl
    // $sqlMaxTgl="SELECT tgl_pembayaran as maxTgl from transaksi where id_pelanggan='$id_pelanggan' ";
    ...
    <table class="table ">
      ...
      <tbody>
        ...
        //     $item = bulan($bulan);
          echo"<tr>";
            echo "<td> 1</td>";
            echo "<td> Biaya Registrasi </td>";
            echo "<td>". $data['jumlah_tunggakan'] ."</td>";
            echo "<td>Rp ". format_rupiah('200000')."</td>";
      ...
      // }
        ...
        <tr>
          <td colspan="3"></td>
          <td >Total :</td>
          <td><?php echo "Rp ".format_rupiah($data['total']).""; ?></td>
