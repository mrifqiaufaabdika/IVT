        ...
        <section class="sidebar">
          ...
          if($_SESSION['tipe']=='admin'){
           ...
           <ul class="sidebar-menu">
            ...
            <li <?php if($active == 'pelanggan') echo 'class="active"'; ?>><a href="?page=pelanggan"><i class="fa fa-group"></i><span>Pelanggan</span></a></li>
            ...
            <li <?php if($active == 'laporan' || $active == 'harian' || $active == 'bulanan'|| $active == 'tahun' || $active == 'priode') echo 'class="active"'; ?>><a href="?page=laporan"><i class="fa fa-file-pdf-o"></i><span>Laporan</span></a></li>
