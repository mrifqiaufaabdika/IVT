...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Delete Pegawai</h4>
        </div>
        <div class="modal-body">
            <form class="form-horizontal" action="../control/prosesPegawai.php?action=delete" name="modal-popup" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="alert alert-danger">Apakah anda yakin ingin menghapus data ini ?</div>
                            ...
                            <div class="form-group">
                                <label class="col-lg-3 control-label">Jabatan</label>
                                    <div class="col-lg-5">
                                        <input style="width: 200px;"  class="form-control" type="text" name="nama" value="<?php echo $row['jabatan']; ?>" readonly/>
                                    </div>
                            </div>
